  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-light via-light to-primary/10 px-4 py-20">
      <div className="container mx-auto max-w-6xl">
        {/* Title - spans full width so the photo below can align with the subtitle baseline */}
        <motion.div
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start mt-8">
          ...
          >
            <div className="relative w-full h-[284px] md:h-[400px] bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl flex items-center justify-center overflow-hidden">
